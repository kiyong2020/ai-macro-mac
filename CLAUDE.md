...
macOS automation app (AppKit + Swift) that drives a golf-reservation web flow by replaying scripted UI actions: clicks, key presses, screen-capture-driven OCR matching, AppleScript-driven Chrome navigation, and SMS-verification-code intake over Socket.IO. UI strings and many comments are in Korean.
